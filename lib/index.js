...
var defaultOptions = {
	...
	sessionConstructor: require('express-session') //Must be set to the session constructor
}
...
SessionStore.prototype.createSession = function(req, sess){
	req.session = new (this.sessionConstructor)(req, sess);
	return req.session;
};

SessionStore.prototype.load = function(sid, fn){
	var self = this;
